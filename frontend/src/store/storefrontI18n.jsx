...
const translations = {
  en: {
    ...
    shippingReturnsDesc: 'Free shipping on orders over 200 SAR. 7-day return policy. Items must be in original condition with tags attached.',
    careInstructions: 'Care Instructions',
    careInstructionsDefault: 'Follow care label instructions. Machine wash cold with similar colors. Do not bleach. Tumble dry low.',
    ...
    trackOrderPhoneRequired: 'Phone number is required',
  ...
  ar: {
    ...
    shippingReturnsDesc: 'شحن مجاني للطلبات فوق 200 ريال. سياسة إرجاع خلال 7 أيام. يجب أن تكون المنتجات في حالتها الأصلية مع البطاقات.',
    careInstructions: 'تعليمات العناية',
    careInstructionsDefault: 'اتبع تعليمات بطاقة العناية. اغسل بالماء البارد مع ألوان مماثلة. لا تستخدم المبيض. جفف على حرارة منخفضة.',
    ...
    trackOrderPhoneRequired: 'رقم الهاتف مطلوب',
